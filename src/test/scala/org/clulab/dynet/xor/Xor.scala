...
object Xor {
  ...
  class XorParameters {
    ...
    val p_W: Parameter = m.addParameters(Dim(HIDDEN_SIZE, 2))
    val p_b: Parameter = m.addParameters(Dim(HIDDEN_SIZE))
    val p_V: Parameter = m.addParameters(Dim(1, HIDDEN_SIZE))
    val p_a: Parameter = m.addParameters(Dim(1))
  }
